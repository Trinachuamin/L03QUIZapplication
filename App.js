...
const App = () => {
  ...
  return (
      <ScrollView style={styles.container}>
        ...
        <Icon name={"paw"} size={25} color={'purple'}><Text>Trina's Animal Quiz</Text></Icon>
        <Text></Text>
